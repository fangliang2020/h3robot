...
class AsyncSocket {
 public:
  ...
  sigslot::signal2<AsyncSocket::Ptr, int>             SignalSocketErrorEvent;   // 错误事件
  sigslot::signal1<AsyncSocket::Ptr>                  SignalSocketWriteEvent;   // 写完成事件
  sigslot::signal2<AsyncSocket::Ptr, MemBuffer::Ptr>  SignalSocketReadEvent;    // 读完成事件
...
class AsyncListener {
 public:
  ...
  // 新连接到来的事件
  sigslot::signal3<AsyncListener::Ptr, Socket::Ptr, int>  SignalNewConnected;
...
class  AsyncConnecter {
 public:
  ...
  // 连接成功的事件
  sigslot::signal3<AsyncConnecter::Ptr, Socket::Ptr, int> SignalServerConnected;
