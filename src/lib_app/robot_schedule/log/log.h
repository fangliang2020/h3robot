...
extern int controlserver_log_level;
...
#define LOG_INFO(format, ...)                                                  \
  do {                                                                         \
    if (controlserver_log_level < LOG_LEVEL_INFO)                                \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_WARN(format, ...)                                                  \
  do {                                                                         \
    if (controlserver_log_level < LOG_LEVEL_WARN)                                \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_ERROR(format, ...)                                                 \
  do {                                                                         \
    if (controlserver_log_level < LOG_LEVEL_ERROR)                               \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_DEBUG(format, ...)                                                 \
  do {                                                                         \
    if (controlserver_log_level < LOG_LEVEL_DEBUG)                               \
      break;                                                                   \
    if (enable_minilog)                                                        \
